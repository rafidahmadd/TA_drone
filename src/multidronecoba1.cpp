...
geometry_msgs::PoseStamped current_position_uav0;
geometry_msgs::PoseStamped current_position_uav1;
geometry_msgs::PoseStamped current_position_uav2;

sensor_msgs::NavSatFix current_gps_position_uav0;
...
// Subscriber Define
ros::Subscriber global_pos_sub_uav0;
...
//}
void follow0(const geometry_msgs::PoseStamped::ConstPtr& fmsg1){
current_position_uav0 = *fmsg1;

}

void follow1(const geometry_msgs::PoseStamped::ConstPtr& fmsg2){
current_position_uav1 = *fmsg2;

}

void follow2(const geometry_msgs::PoseStamped::ConstPtr& fmsg3){
current_position_uav2 = *fmsg3;

}

void gps0(const sensor_msgs::NavSatFix::ConstPtr& gmsg1){
current_gps_position_uav0 = *gmsg1;

}

void gps1(const sensor_msgs::NavSatFix::ConstPtr& gmsg2){
current_gps_position_uav1 = *gmsg2;

}

void gps2(const sensor_msgs::NavSatFix::ConstPtr& gmsg3){
current_gps_position_uav2 = *gmsg3;
...
int main(int argc, char **argv)
{
    ...
    local_pos_sub_uav0 = nh_uav0.subscribe("uav0/mavros/local_position/pose", 10, follow0);
    global_pos_sub_uav0 = nh_uav0.subscribe("uav0/mavros/global_position/global", 10, gps0);
    ...
    local_pos_sub_uav1 = nh_uav1.subscribe("uav1/mavros/local_position/pose", 10, follow1);
    ...
    local_pos_sub_uav2 = nh_uav2.subscribe("uav2/mavros/local_position/pose", 10, follow2);
...
// Takeoff
    ...
    ROS_INFO("ketinggian sudah 3 meter");
      ...
      // Menuju Waypoint B
    pose_uav0.pose.position.x = WP_1_X;
    pose_uav0.pose.position.y = WP_1_Y;
    pose_uav0.pose.position.z = FLIGHT_ALTITUDE;

    pose_uav1.pose.position.x = pose_uav0.pose.position.x;
    pose_uav1.pose.position.y = pose_uav0.pose.position.y+1;
    pose_uav1.pose.position.z = pose_uav0.pose.position.z;
    ...
    pose_uav2.pose.position.x = pose_uav1.pose.position.x;
    pose_uav2.pose.position.y = pose_uav0.pose.position.y -1;
    ...
    // Menuju Waypoint C
    pose_uav0.pose.position.x = WP_2_X;
    pose_uav0.pose.position.y = WP_2_Y;
    pose_uav0.pose.position.z = FLIGHT_ALTITUDE;
