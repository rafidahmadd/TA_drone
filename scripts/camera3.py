...
#         self.image_sub = rospy.Subscriber("iris2/usb_cam/image_raw",Image,self.callback_rgb)
...
#             # cv2.destroyAllWindows()
#             capture = drone.capture
#             cv2.imshow("Capture Window3", capture)
#             key=cv2.waitKey(1) & 0xFF
#             if key == ord ('1'):
#                 print ('image copied to folder images/data/origin')
#                 cv2.imwrite("/home/rafidahmadd/catkin_ws/src/drone_pkg/image_data/"+"base3.jpg",capture)
#             elif key == ord ('2'):
#                 print ('image copied to folder images/data/move')
#                 cv2.imwrite("/home/rafidahmadd/catkin_ws/src/drone_pkg/image_data/"+"move3.jpg",capture)
#             elif key == ord ('3'):
#                 package = 'drone_pkg'
...
if __name__ == "__main__":
    output_path = "/home/rafidahmadd/Pictures/captured/fromDrone/captured_image1.png"
