...
class drone:
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber("iris0/usb_cam/image_raw",Image,self.callback_rgb)
...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        try:
            ...
            # key=cv2.waitKey(1) & 0xFF
            # if key == ord ('1'):
            #     print ('image copied to folder images/compare/origin')
            #     cv2.imwrite("images/compare/"+"base111.jpg",capture)
            # elif key == ord ('2'):
            #     print ('image copied to folder images/compare/move')
            #     cv2.imwrite("images/compare/"+"move111.jpg",capture)
